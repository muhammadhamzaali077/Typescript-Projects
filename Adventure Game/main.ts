  ...
  if (opponent.Select === "Serial Killer") {
    ...
    if (asking.option === "Attack") {
      ...
      if (number > 0) {
        ...
        console.log(
          chalk.bold.red(`${player1.name}'s life is ${player1.life}`)
        );
        console.log(
          chalk.bold.green(`${opponent1.name} life is ${opponent1.life}`)
        );
        if (player1.life <= 0) {
          console.log(
      ...
      if (number <= 0) {
        ...
        console.log(
          chalk.bold.green(`${player1.name} life is ${player1.life}`)
        );
        console.log(
          chalk.bold.red(`${opponent1.name}'s life is ${opponent1.life}`)
        );
        if (opponent1.life <= 0) {
          console.log(
            chalk.green.bold.italic("YOU WIN")
          );
          process.exit()
        }
      }
    ...
    if (asking.option == "Drink Energy") {
      ...
      console.log(
        chalk.bold.italic.green(
          `${player1.name}'s life increased to ${player1.life}`
        )
      );
    }

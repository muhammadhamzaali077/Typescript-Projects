...
if (usrName.userName) {
    ...
    // Question No 2
    let ques2 = chalk.bold.blue("Q2. Which tool is commonly used to transpile TypeScript to JavaScript?");
    console.log(ques2);
    ...
    // Question No 3
    let ques3 = chalk.bold.blue("Q3. Which keyword is used to declare variables in TypeScript?");
    console.log(ques3);
    ...
    // Question No 5
    let ques5 = chalk.bold.blue("Q5. What is the key difference between the interface and type in TypeScript?");
    console.log(ques5);
    ...
    // Question No 6
    let ques6 = chalk.bold.blue("What is the purpose of the never type in TypeScript?");
    console.log(ques6);
    ...
    let result = score;
    if (result > 5) {
        console.log(`Excellent ${usrName.userName}, Your score is ${chalk.bold.italic.green(result)}`);
    }
    else if (result > 3 && score < 5) {
        console.log(`Good ${usrName.userName}, Your score is ${chalk.bold.italic.green(result)}`);
    }
    else {
        console.log(`Nice try ${usrName.userName}, Your score is ${chalk.bold.italic.red(result)}, Try Again`);
    }
}
